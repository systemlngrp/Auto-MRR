...
function ReelLabelsTab() {
  const [searchMrr, setSearchMrr] = useState('');
...
function App() {
  ...
  return (
    <div className="app">
      ...
      {activeTab === 'labels' && <ReelLabelsTab />}
    </div>
  );
}
