...
export default function UsersPage({ selectedFirm, deps, onBack, currentUser, initialView = 'list' }) {
  ...
  const MENU_OPTIONS = [
    ...
    { key: 'dpm_jobs', label: 'DPM Jobs' },
    { key: 'pending_reel_issue_return', label: 'Pending Reel Issue/Return' },
    { key: 'pending_sheet_plant', label: 'Pending Sheet Plant' },
    { key: 'pending_printing', label: 'Pending Printing' },
    { key: 'pending_closer', label: 'Pending Closer' },
